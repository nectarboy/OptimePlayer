    ...
    executeOpcode(opcode) {
        if (opcode <= 0x7F) {
            ...
            switch (opcode) {
                case 0x80: // Rest
                {
                    var ticks = this.readLastVariableLength();
                    if (this.exeCommandFlag) {
                        this.restingFor = ticks;
                ...
                {
                    if (this.exeCommandFlag) {
                        //this.exeCommandFlag = this.conditionalFlag;
                        if (!this.conditionalFlag)
                            this.pc += this.determineCommandLength(this.pc);
                        this.debugLogForce('CONDITIONAL EXE, opcode is ' + hexN(this.readPc(),2));
                    }
                    break;
                }
                case 0xC0: // Pan
                {
                    let pan = this.readLastPcInc();

                    if (this.exeCommandFlag) {
                        this.pan = pan & 0x7f; // TODO: how does the driver handle invalid values ??
                ...
                case 0xC1: // Volume
                {
                    let volume = this.readLastPcInc();

                    if (this.exeCommandFlag) {
                        this.volume = volume & 0xff;
                ...
                case 0xC3: // Transpose
                {
                    var transpose = this.readLastPcInc();

                    if (this.exeCommandFlag) {
                        this.transpose = transpose << 24 >> 24;
                ...
                {
                    var pitchBend = this.readLastPcInc();

                    if (this.exeCommandFlag) {
                        this.pitchBend = pitchBend << 24 >> 24;
                ...
                {
                    let pitchBendRange = this.readLastPcInc();

                    if (this.exeCommandFlag) {
                        this.pitchBendRange = pitchBendRange & 0xff;
                ...
                {
                    let priority = this.readLastPcInc();

                    if (this.exeCommandFlag) {
                        this.priority = priority & 0xff;
                ...
                {
                    let tie = this.readLastPcInc();

                    if (this.exeCommandFlag) {
                        this.tie = bitTest(tie, 0);
                ...
                case 0xC9: // Portamento Control
                {
                    ...
                    if (this.exeCommandFlag) {
                        this.portamentoKey = (param + this.transpose);
                ...
                case 0xCE: // Portamento On / Off
                {
                    let param = this.readLastPcInc();
                    if (this.exeCommandFlag) {
                        this.portamentoEnable = param & 0xff;
                ...
                case 0xCF: // Portamento Time
                {
                    let param = this.readLastPcInc();
                    if (this.exeCommandFlag) {
                        this.portamentoTime = param & 0xff;
                ...
                case 0xB0: // Set Variable
                {
                    ...
                    var val = this.readLastPcInc(2);
                    if (this.exeCommandFlag) {
                        this.sequence.writeVar(index, val << 16 >> 16);
                    }
                    break;
                }
                case 0xB1: // Add Variable
                {
                    var index = this.readLastPcInc();
                    var val = this.readLastPcInc(2);
                    if (this.exeCommandFlag) {
                        this.sequence.writeVar(index, this.sequence.readVar(index) + (val << 16 >> 16));
                    }
                    break;
                }
